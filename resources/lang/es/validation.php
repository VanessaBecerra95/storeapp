...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de validación del lenguaje
    |--------------------------------------------------------------------------
    |
    ...
    | como las reglas de tamaño. Siéntete libre de modificar cada uno de estos mensajes.
    |
    */
    ...
    | usando la convención "attribute.rule" para nombrar las líneas. Esto ayuda a
    | personalizar un mensaje específico para una regla determinada de un atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para intercambiar nuestro marcador de posición
    | de atributos por algo más amigable para el lector, como "Correo Electrónico"
    | en lugar de "email". Esto ayuda a que los mensajes sean más claros.
    |
    */
